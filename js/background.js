...
(function(window) {
    ...
    L.Icon.Pulse = L.DivIcon.extend({
        ...
        initialize: function(options) {
            ...
            'animation: pulsate ' + this.options.heartbeat + 's ease-out', 'animation-iteration-count: infinite', 'animation-delay: ' + (this.options.heartbeat + .1) + 's', 'position:absolute', 'left:0', ];
...
(function() {
    var addSimilar, checkImageVisibility, defineMarker, fetchLocationData, getMaxImage, setMap, listenToLogo, locationMap, observer, setMapUnderImage, setMultipleMapboxMap;
    this.mapDiv = null;
    ...
    ;
    setMap = function(koloData) {
        if (isMobile()) {
            return setMobileMap(koloData);
        } else {
            return setMapUnderImage(koloData);
        }
    }
    ...
    setMobileMap = function(koloData) {
        ...
        map_div.style.width = window.innerWidth + "px";
